...
namespace PlayerController
{
    ...
    public class ScriptableStats : ScriptableObject
    {
        ...
        [Tooltip("La capacidad el jugador para ganar velocidad horizontal")]
        ...
        [Tooltip("Fuerza con la que se realiza el dash")]
        public float dashingPower;
        
        [Tooltip("Tiempo en el que se realiza el dash")]
        public float dashingTime;
        
        [Tooltip("Cooldown antes de poder lanzar otro dash")]
